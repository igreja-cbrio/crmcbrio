...
const styles = {
  ...
  sectionTitle: { fontSize: 14, fontWeight: 700, color: C.text, marginBottom: 12, marginTop: 24, lineHeight: 1.25 },
  taskCard: {
  ...
  subtaskRow: { display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0', fontSize: 14, color: C.text, lineHeight: 1.5 },
  ...
  backBtn: { background: 'none', border: 'none', cursor: 'pointer', color: C.primary, fontWeight: 600, fontSize: 14, padding: 0, marginBottom: 16 },
  inlineInput: { padding: '4px 8px', borderRadius: 6, border: `1px solid ${C.border}`, fontSize: 12, outline: 'none', flex: 1 },
  inlineBtn: { padding: '4px 10px', borderRadius: 6, border: 'none', background: C.primary, color: '#fff', fontSize: 12, fontWeight: 600, cursor: 'pointer' },
};
